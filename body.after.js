...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var v3RegisterButton = document.getElementById('v3-register-btn');

    if (v3RegisterButton) {
        v3RegisterButton.addEventListener('click', function () {
            // Chamar a função handleButtonClick quando o botão v3-register-btn for clicado
            handleButtonClick();
        });
    } else {
        console.error('Elemento do botão "v3-register-btn" não encontrado.');
    }
});