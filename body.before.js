...
function carregarimagemsuperodds() {
    ...
    if (document.querySelector('.style__Coeficient-sc-3ucvic-1 span')) {
...
document.addEventListener('readystatechange', (event) => {
    ...
    if (document.querySelector('#r1823')) {
        document.querySelector('#r1823').addEventListener("DOMSubtreeModified", function () {
            // if ($('.style__SBCol-sc-19dmv8n-0 .style__Coeficient-sc-3ucvic-1 span.v3-icon').html() 
            // == !'<img src="https://bet-files.suprema.group/images/SUPERODDS.png" style="width: 14px;height: 14px;min-width: 14px;min-height: 14px;">'
            // || $('.style__Coeficient-sc-3ucvic-1 span').html() 
            // == !'<img src="https://bet-files.suprema.group/images/SUPERODDS.png" style="width: 14px;height: 14px;min-width: 14px;min-height: 14px;">') {
            //     carregarimagemsuperodds()
