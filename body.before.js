...
function carregarimagemsuperodds() {
    //Imagem superodds
    if (document.querySelector('.style__SBCol-sc-19dmv8n-0 .style__Coeficient-sc-3ucvic-1 span.v3-icon' && $('.style__SBCol-sc-19dmv8n-0 .style__Coeficient-sc-3ucvic-1 span.v3-icon').html() !== '<img src="https://bet-files.suprema.group/images/SUPERODDS.png" style="width: 14px;height: 14px;min-width: 14px;min-height: 14px;">')) {
    ...
    if (document.querySelector('.style__Coeficient-sc-3ucvic-1 span') && $('.style__Coeficient-sc-3ucvic-1 span').html() !== '<img src="https://bet-files.suprema.group/images/SUPERODDS.png" style="width: 14px;height: 14px;min-width: 14px;min-height: 14px;">') {
